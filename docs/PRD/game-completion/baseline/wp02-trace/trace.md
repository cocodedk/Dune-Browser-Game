...
| 3 | **One crew harvest** | **production UI** — CrewPanel `red_wall_pan` target button; `setTime` ×3 days (labeled) | spice 60 → 64.80043569593501; six "Crews deliver 1.6 spice" events — the only income source |
