...
const DEFAULT: PortraitDef = {
  ...
  framing: 0.5, keyHardness: 0.5, build: 1,
}
...
const PORTRAITS: Record<string, PortraitDef> = {
  ...
  duke_armand: {
    ...
    rim: '#c9b8e0', figure: '#1d1628', framing: 0.25, keyHardness: 0.35, build: 1.05,
  },
  maren: {
    backTop: '#7a5a72', backBottom: '#2a1d2e',
    rim: '#e0b8d4', figure: '#221824', framing: 0.35, keyHardness: 0.3, build: 0.95,
  },

  // Imperial functionaries: bloodless, evenly lit, no warmth at all.
  corvin: {
    backTop: '#5a6a72', backBottom: '#1d2529',
    rim: '#9fc4d0', figure: '#161d21', framing: 0.2, keyHardness: 0.2, build: 0.9,
  },
  vell: {
    backTop: '#6b6355', backBottom: '#282419',
    rim: '#c4b89a', figure: '#1f1c14', framing: 0.4, keyHardness: 0.4, build: 1,
  },

  // Fremen: desert palette, hard sun, framed close.
  shadir: {
    backTop: '#b07038', backBottom: '#3d2413',
    rim: '#5aa9c8', figure: '#2a1809', framing: 0.7, keyHardness: 0.9, build: 1.1,
  },
  ysane: {
    backTop: '#c08a4a', backBottom: '#422a15',
    rim: '#5aa9c8', figure: '#2d1b0c', framing: 0.85, keyHardness: 0.85, build: 0.85,
  },
  sova: {
    backTop: '#8a5a3a', backBottom: '#301c10',
    rim: '#5aa9c8', figure: '#231407', framing: 0.6, keyHardness: 0.55, build: 0.9,
  },
  pell: {
    backTop: '#c99a52', backBottom: '#4a3018',
    rim: '#7ac4d8', figure: '#2f1d0d', framing: 0.9, keyHardness: 0.8, build: 0.8,
  },
