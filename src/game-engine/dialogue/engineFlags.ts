...
export const ENGINE_WRITTEN_FLAGS: Readonly<Record<string, string>> = {
  ...
  'pledged.count': 'SietchSystem.pledgePlayerSietch(), economy/sietchLoyaltyRun.runSietchLoyaltyDay() — CombatSystem.attackVillage() no longer writes this (W2b killed the combat pledge path)',
